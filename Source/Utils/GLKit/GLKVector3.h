...
static __inline__ GLKVector3 GLKVector3Add(GLKVector3 vectorLeft, GLKVector3 vectorRight);
static __inline__ GLKVector3 GLKVector3Subtract(GLKVector3 vectorLeft, GLKVector3 vectorRight);
static __inline__ GLKVector3 GLKVector3Multiply(GLKVector3 vectorLeft, GLKVector3 vectorRight);
static __inline__ GLKVector3 GLKVector3Divide(GLKVector3 vectorLeft, GLKVector3 vectorRight);
        
static __inline__ GLKVector3 GLKVector3AddScalar(GLKVector3 vector, float value);
static __inline__ GLKVector3 GLKVector3SubtractScalar(GLKVector3 vector, float value);
static __inline__ GLKVector3 GLKVector3MultiplyScalar(GLKVector3 vector, float value);
static __inline__ GLKVector3 GLKVector3DivideScalar(GLKVector3 vector, float value);
	
/*
 Returns a vector whose elements are the larger of the corresponding elements of the vector arguments.
 */
static __inline__ GLKVector3 GLKVector3Maximum(GLKVector3 vectorLeft, GLKVector3 vectorRight);
/*
 Returns a vector whose elements are the smaller of the corresponding elements of the vector arguments.
 */
static __inline__ GLKVector3 GLKVector3Minimum(GLKVector3 vectorLeft, GLKVector3 vectorRight);
    
/*
 Returns true if all of the first vector's elements are equal to all of the second vector's arguments.
 */
static __inline__ bool GLKVector3AllEqualToVector3(GLKVector3 vectorLeft, GLKVector3 vectorRight);
/*
 ...
 */
static __inline__ bool GLKVector3AllGreaterThanVector3(GLKVector3 vectorLeft, GLKVector3 vectorRight);
/*
 ...
 */
static __inline__ bool GLKVector3AllGreaterThanOrEqualToVector3(GLKVector3 vectorLeft, GLKVector3 vectorRight);
/*
...
static __inline__ GLKVector3 GLKVector3Normalize(GLKVector3 vector);

static __inline__ float GLKVector3DotProduct(GLKVector3 vectorLeft, GLKVector3 vectorRight);
static __inline__ float GLKVector3Length(GLKVector3 vector);
static __inline__ float GLKVector3Distance(GLKVector3 vectorStart, GLKVector3 vectorEnd);

static __inline__ GLKVector3 GLKVector3Lerp(GLKVector3 vectorStart, GLKVector3 vectorEnd, float t);

static __inline__ GLKVector3 GLKVector3CrossProduct(GLKVector3 vectorLeft, GLKVector3 vectorRight);
